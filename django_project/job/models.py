...
class Job(models.Model):
    ...
    job_description = models.TextField(default=True)
    job_objectives = models.TextField(default=True)
    job_skills =  models.TextField(default=True)
    ideal_candidate = models.TextField()
    is_available = models.BooleanField(default=True)
    contact_number = models.CharField(max_length=15, default=True)
